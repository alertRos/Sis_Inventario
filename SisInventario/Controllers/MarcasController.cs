    ...
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marcas != null ? 
                          ...
                          Problem("Entity set 'InventarioContext.Marcas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Email,Telefono")] Marcas marcas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Email,Telefono")] Marcas marcas)
        {
            if (id != marcas.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InventarioContext.Marcas'  is null.");
            }
            var marcas = await _context.Marcas.FindAsync(id);
            if (marcas != null)
            {
